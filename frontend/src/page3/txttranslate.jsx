...
//     try {
//       const response = await fetch("http://localhost:5000/extract-text-translate-ai", {
//         method: "POST",
//         body: formData,
//       });
...
//           <h1 className="h1 text-center text-black">Image Translator
//           </h1>
//           <p className="text text-center text-black slogan">
//          An Online tool to translate texts and documents.</p>
