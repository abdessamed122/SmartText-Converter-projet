...
//   const [uploadResponse, setUploadResponse] = useState(""); // لإظهار نتيجة الرد
...
//     try {
//       const response = await fetch("http://localhost:5000/extract-text-summarize-ai", {
//         method: "POST",
//         body: formData,
//       });
  
//       if (!response.ok) {
//         const errorText = await response.text(); // قراءة النص بدلاً من JSON
...
//       link.href = url;
//       link.download = 'extracted-text.txt'; // اسم ملف النص
//       link.click();
//       URL.revokeObjectURL(url); // إلغاء الرابط بعد التحميل
//     }
//   };
...
//           <h1 className="h1 text-center text-black">Summarize and explain the text</h1>
//           <p className="text text-center text-black slogan">
//           Online tool to extract and summarize texts and documents.</p>
...
//                       <br /> <small> Supported formats: JPG, PNG, GIF, JFIF (JPEG), HEIC, PDF

// </small>
//                       </span>
//                       <div className="selection-div"> 
//   <div className="dropdown browse-btn">
//     <label htmlFor="file" className="browse-dropbtn">
//       Browse
//     </label>
//     <input
//       id="file"
...
//                           <h3>النتيجة:</h3>
//                           <textarea className='img-text'>{uploadResponse}</textarea>
//                           <img
//                             className="single_text_copy_btn"
//                             id={0}
//                             src="https://www.imagetotext.info/web_assets/frontend/img/copy.svg"
//                             alt="copy image icon"
//                             onClick={handleCopy} // نسخ النص عند الضغط على الصورة
...
const Main = () => {
  ...
  return (
    <div>
      <section className="section home tool-section">
        <div className="container">
          <h1 className="h1 text-center text-black">Summarize and explain the text
          </h1>
          <p className="text text-center text-black slogan">
         An Online tool to extract and summarize texts and documents.          </p>
          <div className="tool home tool-grid">
            <div>
              <div className="tool-span">
                <div className="tool-area">
